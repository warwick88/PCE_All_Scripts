 ...
 DECLARE @ClaimLineId int = 9179084  		/*set value to this variable with ClaimLIneId that has missing credit*/
 DECLARE @CheckId int= 17930				/*set value to this variable with the corresponding checkid from Checks table*/
 DECLARE @Amount money = 28.84		/*set value to this variable with  Amount to credit*/
