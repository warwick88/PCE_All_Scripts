...
where providername like '%WMU%'

select * from Providers
where providerid=998
...
VALUES ('Wbarlow',getdate(),'Wbarlow',getdate(),'WMU - Autism Center of Excellence',1356744692,'Y')
...
VALUES (49,998,1046,'Y','Wbarlow',getdate(),'Wbarlow',getdate())
...
VALUES ('Wbarlow',getdate(),'Wbarlow',getdate(),24876,49)

insert into Staff837Senders (CreatedBy,CreatedDate,ModifiedBy,ModifiedDate,StaffId,Import837SenderId)
VALUES ('Wbarlow',getdate(),'Wbarlow',getdate(),37753,49)
