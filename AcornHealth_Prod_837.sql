...
VALUES ('Wbarlow',getdate(),'Wbarlow',getdate(),'Acorn Health of Michigan',1558841163,'Y')
...
VALUES (49,1358,1518,'Y','Wbarlow',getdate(),'Wbarlow',getdate())

select * from Providers
where providerid=1358
...
VALUES ('Wbarlow',getdate(),'Wbarlow',getdate(),34616,49)
