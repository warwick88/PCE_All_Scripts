...
With CTE_CCBHC
	As(SELECT r.ServiceId
                            ...
                            WHERE r.DateOfService >= cch.StartDate
								...
								JOIN ClientCoveragePlans ccp ON ccp.ClientId = r.ClientId
								JOIN ClientCoverageHistory cch ON cch.ClientCoveragePlanId = ccp.ClientCoveragePlanId AND cch.ServiceAreaId = r.ServiceAreaId
								JOIN CustomGLAccountCoveragePlans cap ON cap.CoveragePlanId = ccp.CoveragePlanId AND cap.AccountSubtype IN ( 'CCBHC' )
								JOIN CoveragePlans cp ON cp.CoveragePlanId = ccp.CoveragePlanId
								where r.serviceid in (
								1072325,
								1159766,
								1150438,
								1183065,
								...
								select * from customglaccountcoverageplans
								WHERE ACCOUNTSUBTYPE='CCBHC'
