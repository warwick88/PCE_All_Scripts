...
select * from staff
where lastname like 'Farero%'

--Select specified users to keep active
select StaffId,USERCODE,LastName,FirstName,Active into #tempadditions FROM Staff
where staffid in (1112,1113,23,682,1912,12,31013,682,39047,39043,39826,1831,894,30994,920,25481,39083,39045,26277,39069,25911)
